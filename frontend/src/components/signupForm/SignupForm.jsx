...
const SignupForm = () => {
        ...
        const showFlash = (message, type = 'info', redirect = null) => {
                setFlash({
                        message,
                        type,
                    ...
                    <Formik
                        ...
                        onSubmit={async (values, actions) => {
                                try {
                                        ...
                                        actions.resetForm();
                                        showFlash('Te registraste correctamente. Ahora podés verificar tu cuenta.', 'success', '/');
                                } catch (error) {
                                        console.error(error);
                                        showFlash(error.message || 'Ocurrió un error al registrarse.', 'error');
                                }
                        }}
                    >
                            <Form>
